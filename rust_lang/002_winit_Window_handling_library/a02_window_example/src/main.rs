...
impl Application {
    fn new<T>(event_loop: &EventLoop<T>) -> Self {
        ...
        let custom_cursors = vec![
            event_loop.create_custom_cursor(decode_cursor(include_bytes!("../assets/cross.png"))),
            event_loop.create_custom_cursor(decode_cursor(include_bytes!("../assets/cross2.png"))),
            event_loop
                .create_custom_cursor(decode_cursor(include_bytes!("../assets/gradient.png"))),
        ];
