...
impl<'a> RenderState<'a> {
    ...
    pub fn create_pipelines(&mut self) {
        ...
        let transition_shader_module = self
            .device
            .create_shader_module(wgpu::include_wgsl!("../../assets/transition.wgsl"));
        self.transition_pipeline = Some(self.device.create_compute_pipeline(
            ...
            self.device
                .create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                    ...
                    bind_group_layouts: &[
                        ...
                        &surface_size_bind_group_layout,
                    ],
                    push_constant_ranges: &[],
                });

        // Create the display pipeline
        let display_shader_module = self
            .device
            .create_shader_module(wgpu::include_wgsl!("./../../assets/display.wgsl"));
    ...
    pub fn transition(&mut self) -> CommandBuffer {
...

        {
            ...
            compute_pass.set_bind_group(
                0,
                texture_resource.transition_bind_group.as_ref().unwrap(),
                &[],
            );
    ...
    pub fn draw(&mut self) {
        ...
        self.queue
            .submit([transition_command_buffer, encoder.finish()].into_iter());
        output.present();
    }
