  ...
  while (SDL_PollEvent(&event)) {
    ...
    case SDL_WINDOWEVENT: {
      ...
      case SDL_WINDOWEVENT_RESIZED: {
        ...
        // NOTE: This goes in an infinite loop when maximising a window that has
        // an odd width/height.
        /*if ( ( event.window.data1 % 2 == 1 ) || ( event.window.data2 % 2 == 1
        ) ) { u32 new_width = ( u32 )( event.window.data1 % 2 == 0 ?
        event.window.data1 : event.window.data1 - 1 ); u32 new_height = ( u32 )(
        event.window.data2 % 2 == 0 ? event.window.data2 : event.window.data2 -
        1 );
