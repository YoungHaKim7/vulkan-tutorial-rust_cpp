...
static void computeOrder(unsigned int *result,
...
static void computeHistogram(unsigned int (&hist)[1024][3],
                             const unsigned int *data, size_t count) {
...
static void radixPass(unsigned int *destination, const unsigned int *source,
                      const unsigned int *keys, size_t count,
...
void meshopt_spatialSortRemap(unsigned int *destination,
...
void meshopt_spatialSortTriangles(unsigned int *destination,
