...
enum ImGuiBackendFlags_ {
  ...
  ImGuiBackendFlags_HasMouseHoveredViewport =
      1
      << 11, // Backend Platform supports setting io.MouseHoveredViewport to the
             // viewport directly under the mouse _IGNORING_ viewports with the
             // ImGuiViewportFlags_NoInputs flag and _REGARDLESS_ of whether
             // another viewport is focused and may be capturing the mouse. This
             // information is _NOT EASY_ to provide correctly with most
             // high-level engines! Don't set this without studying _carefully_
             // how the backends handle ImGuiViewportFlags_NoInputs!
...
struct ImGuiTableColumnSortSpecs {
  ...
  ImGuiSortDirection SortDirection
      : 8; // ImGuiSortDirection_Ascending or ImGuiSortDirection_Descending (you
           // can use this or SortSign, whichever is more convenient for your
           // sort function)
...
struct ImGuiViewport {
  ...
  void *PlatformHandleRaw; // void* to hold lower-level, platform-native window
                           // handle (e.g. the HWND) when using an abstraction
                           // layer like GLFW or SDL (where PlatformHandle would
                           // be a SDL_Window*)
  bool
...
struct ImGuiPlatformIO {
  ...
  void (*Platform_SetImeInputPos)(
      ImGuiViewport *vp,
      ImVec2 pos); // . F . . .  // (Optional) Set IME (Input Method Editor,
                   // e.g. for Asian languages) input position, so text preview
                   // appears over the imgui input box. FIXME: The call timing
                   // of this is inconsistent because we want to support without
                   // multi-viewports.
